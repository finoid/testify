...
import au.com.origin.snapshots.serializers.v1.Base64SnapshotSerializer;
...
public class Base64SnapshotDsl extends ScenarioSnapshotDsl {
    ...
    public <T> void snapshot(final T toBeSnapshotted) {
        expect.serializer(new Base64SnapshotSerializer()) // TODO (nw) option to pass simple module?
            .scenario(scenario)
