...
/**
 * A JUnit extension that manages an MSSQLServer test container instance for integration and e2e tests.
 *
 * <pre>{@code
 * @RegisterExtension
 * static final MSSQLServerContainerExtension MSSQL = MSSQLServerContainerExtension.create(
 *     MSSQLServerContainerExtension.Configuration.defaultConfiguration()
 *         .dockerImage(DockerImageName.parse("<docker repository proxy>/mssql/server:2022-latest")
...
public class MSSQLServerContainerExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    private MSSQLServerContainerExtension(final Configuration configuration) {
    ...
    /**
     * Sets up the MSSQLServer container before all tests are run.
     *
                ...
                this.container = new MSSQLServerContainer<>(configuration.dockerImage)
                    ...
                    .withCreateContainerCmdModifier(cmd -> cmd.withHostConfig(
                        HostConfig.newHostConfig()
                            .withPortBindings(new PortBinding(Ports.Binding.bindPort(configuration.hostPort), new ExposedPort(configuration.containerPort)))
                    ))
                    .withConnectTimeoutSeconds(configuration.connectTimeoutSeconds)
                    .withReuse(configuration.reuse);
            }
    ...
    /**
     * Retrieves the host address of the MSSQLServer container.
     *
    ...
    /**
     * Retrieves the port number exposed to the MSSQLServer service inside the container.
     *
    ...
    /**
     * Retrieves the JdbcUrl from the MSSQLServer service inside the container.
     *
     * @return The jdbc url.
     * @throws IllegalStateException in case the container hasn't been created yet.
     */
     ...
     *
     * @return the username used by the container (usually "sa").
     * @throws IllegalStateException in case the container hasn't been created yet.
     */
    @SuppressWarnings("resource")
    ...
    /**
     * Factory method to create a new instance of MSSQLServerContainerExtension with default configuration.
     *
     * @return A new instance of MSSQLServerContainerExtension.
     */
    public static MSSQLServerContainerExtension create() {
        return new MSSQLServerContainerExtension(Configuration.defaultConfiguration());
    }

    /**
     * Factory method to create a new instance of MSSQLServerContainerExtension with custom configuration.
     *
     * @return A new instance of MSSQLServerContainerExtension.
     * @throws IllegalArgumentException in case of an invalid configuration
     */
    public static MSSQLServerContainerExtension create(final Configuration configuration) {
        return new MSSQLServerContainerExtension(configuration);
    }

    /**
     * Configuration class for {@link MSSQLServerContainerExtension}. Allows setting custom configurations for the MSSQLServer Docker container.
     */
    @Getter
    @NoArgsConstructor(access = AccessLevel.PRIVATE)
    public static class Configuration {
        private static final int DEFAULT_HOST_PORT = 1434;
        private static final int DEFAULT_CONTAINER_PORT = 1433;
        private static final int DEFAULT_CONNECTION_TIMEOUT_SECONDS = 240;

        private int hostPort = DEFAULT_HOST_PORT;
        private int containerPort = DEFAULT_CONTAINER_PORT;
        private int connectTimeoutSeconds = DEFAULT_CONNECTION_TIMEOUT_SECONDS;
        private String password = "Secret1234";
        private boolean reuse = true;

        private DockerImageName dockerImage = DockerImageName.parse("mcr.microsoft.com/mssql/server:2022-latest");
        ...
        /**
         * Sets the connection timeout in the container.
         *
         * @param connectTimeoutSeconds The connection timeout in seconds.
         * @return This Configuration object for chaining.
         */
        public Configuration connectTimeoutSeconds(final int connectTimeoutSeconds) {
        ...
        /**
         * Sets the Docker image to be used for the MSSQLServer container.
         *
         * @param dockerImage The Docker image.
         * @return This Configuration object for chaining.
         * @throws IllegalArgumentException if the docker image is null
         */
        ...
        /**
         * Returns the default configuration for the MSSQLServer container.
         *
